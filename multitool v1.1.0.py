...
while True:
    print('Welcome, press assigned number to execute a function or (R) to return to the previous menu')
    ...
    if tool in ('1', '2', '3'):
        ...
        if tool == '1':
            ...
            while True:
                ...
                print('''Select operation (or tool by entering R): 
                    ...
                    if choice == '1':
                        ...
                        while True:
                            ...
                            if weight.upper() == 'L':
                                ...
                                print(f'You are {num4}Kg, that equals {num4*2.2}Lbs.')
                                break
